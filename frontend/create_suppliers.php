...
<body>
    <div class="container mx-auto p-4 pt-6 mt-10 bg-gray-100 rounded-lg shadow-lg">
        <h1 class="text-3xl text-gray-700 font-bold mb-4">Create Supplier</h1>
        <form id="create-supplier-form">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Create Supplier</button>
        </form>
    </div>
